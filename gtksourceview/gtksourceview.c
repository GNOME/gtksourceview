...
gtk_source_view_real_populate_popup (GtkTextView *text_view, GtkMenu *menu)
{
  ...
  gtk_widget_set_sensitive(menuitem, !gtk_source_buffer_undo_is_empty (GTK_SOURCE_BUFFER(buffer)));
  gtk_widget_show (menuitem);
  ...
  gtk_widget_set_sensitive(menuitem, !gtk_source_buffer_redo_is_empty (GTK_SOURCE_BUFFER(buffer)));
  gtk_widget_show (menuitem);
}
