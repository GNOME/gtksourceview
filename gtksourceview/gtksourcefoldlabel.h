...
#define GTK_TYPE_SOURCE_FOLD_LABEL		(gtk_source_fold_label_get_type ())
...
GType			 gtk_source_fold_label_get_type		(void) G_GNUC_CONST;

GtkWidget		*gtk_source_fold_label_new		(GtkSourceView      *view);

void			 gtk_source_fold_label_get_position	(GtkSourceFoldLabel *label,
								 int                *x,
								 int                *y);
void			 gtk_source_fold_label_set_position	(GtkSourceFoldLabel *label,
								 int                 x,
								 int                 y);
