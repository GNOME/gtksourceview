...
gtk_pattern_tag_get_type (void)
{
    ...
    if (our_type == 0)
    {
        ...
        our_type = g_type_register_static (GTK_TYPE_TEXT_TAG, "GtkPatternTag", &our_info, 0);
    }
    return(our_type);
}
...
gtk_embedded_tag_get_type(void)
{
    ...
    if (our_type == 0)
    {
        ...
        our_type = g_type_register_static(GTK_TYPE_TEXT_TAG, "GtkEmbeddedTag", &our_info, 0);
    }
    return our_type;
}
